...
export const addCourseDetails = async (data, token) => {
  ...
  const toastId = toast.loading("Loading...");
  try {
    console.log("FORM DATA,..",data.title,"....",data.price,"...........",data.tags);
...
export const editCourseDetails = async (data, token) => {
  ...
  const toastId = toast.loading("Loading...");
  try {
    console.log("DATA OF API BEFORE EDIT COURWSE????????????",data)
...
export const createSection = async (data, token) => {
  ...
  const toastId = toast.loading("Loading...");
  try {
    console.log("createsection DATA........",data);
...
export const createSubSection = async (data, token) => {
  let result = null;
  console.log("CREATING SUBSECTION DATA.......",data.lectureTitle," ",data.video," ",data.courseId," ",data.sectionId)
  ...
  try {
    ...
    console.log("THIS  SHOULD BE THE RESULT: ",response?.data?.updatesection)
...
export const createRating = async (data, token) => {
  ...
  let success = false;
  try {
    console.log("API CALL CREATED.......................",data);
