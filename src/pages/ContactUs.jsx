...
const ContactUs = () => {
    ...
    const onSubmit = async (data) => {
        ...
        console.log("Messafe response............", res)
  ...
  return (
    loading?(<div className=".custom-loader w-screen h-screen overflow-hidden flex justify-center items-center "><div className="custom-loader"></div></div>):(
    <div className='mx-auto bg-richblack-25 p-5 mt-1.5'>
        ...
        <div className='flex flex-col gap-2'>
            ...
            <div className='flex gap-5'>
                ...
                <select type="text" name="countrycode" id="countryCode" className="form-style bg-yellow-50 rounded-md py-1 px-1" {...register("countryCode",{required:true})}>
                    {
