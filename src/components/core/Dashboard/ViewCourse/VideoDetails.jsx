...
const VideoDetails = () => {
  ...
  // console.log("DATA.........",courseId,sectionId,subsectionId);
  ...
  useEffect (() => {
    ...
    console.log("COURSE DATA AT POINT.......................",courseSectionData,sectionId);
    ...
    console.log("Filtered Section (Debug):", filteredSection);

    const filteredSubsection = filteredSection?.subSection?.find((subsection) => subsection._id === subsectionId);
    console.log("FILTERED SUB SECTION................",filteredSubsection);
  ...
  return (
    <div className='md:w-[calc(100vw-320px)] text-white w-screen p-3'>
      {
