...
const CourseInformationForm = () => {
    ...
    useEffect(()=> {
        const getCategories = async() => {
            ...
            if(categories.allCatagory?.length > 0) {
                setCourseCategories(categories.allCatagory);
            }
        ...
        if(editCourse) {
            ...
            console.log("COURSE AT RENDERE.........",course.category);
    ...
    const onSubmit = async(data) => {
        ...
        console.log("Tags After the submit btn pressed...................",data.courseTags);
        
        console.log("BEFORE add course API call");
        console.log("PRINTING FORMDATA", formData.category,formData.instructions);
        setLoading(true);
  ...
  return (
    ...
    className='space-y-5 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6'
    >
        ...
        <div className='relative flex flex-col space-y-2'>
            ...
            <input
                ...
                className='form-style w-full h-8 !pl-12'
            />
            <HiOutlineCurrencyRupee size={30}  className='absolute top-[20px] left-1 text-richblack-400'/>
            {
                errors.coursePrice && (
        ...
        <div className='flex flex-col space-y-2'>
            ...
            >
                {/* <option value={`${editCourse?:''}`} disabled>Choose a Category</option> */}
        ...
        <div className='flex justify-end gap-x-2'>
            ...
            <IconBtn type={"submit"}
                ...
                customClasses={"bg-richblack-500 px-2 rounded-md"}
                />
        </div>
    </form>
  )
